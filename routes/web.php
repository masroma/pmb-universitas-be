...
use App\Http\Controllers\Admin\PmbCbtAdminController;
...
Route::middleware('auth')->prefix('admin')->name('admin.')->group(function (): void {
    ...
    Route::put('/pendaftaran-lokal/{application}/cbt', [PmbLocalApplicationController::class, 'updateCbt'])->middleware('admin.role:super_admin,admin_pmb')->name('local-applications.cbt.update');
    Route::get('/cbt', [PmbCbtAdminController::class, 'index'])->middleware('admin.role:super_admin,admin_pmb')->name('pmb-cbt.index');
    Route::get('/cbt/soal/create', [PmbCbtAdminController::class, 'create'])->middleware('admin.role:super_admin,admin_pmb')->name('pmb-cbt.create');
    Route::post('/cbt/soal', [PmbCbtAdminController::class, 'store'])->middleware('admin.role:super_admin,admin_pmb')->name('pmb-cbt.store');
    Route::get('/cbt/soal/{question}/edit', [PmbCbtAdminController::class, 'edit'])->middleware('admin.role:super_admin,admin_pmb')->name('pmb-cbt.edit');
    Route::put('/cbt/soal/{question}', [PmbCbtAdminController::class, 'update'])->middleware('admin.role:super_admin,admin_pmb')->name('pmb-cbt.update');
    Route::delete('/cbt/soal/{question}', [PmbCbtAdminController::class, 'destroy'])->middleware('admin.role:super_admin,admin_pmb')->name('pmb-cbt.destroy');
    Route::put('/cbt/pengaturan', [PmbCbtAdminController::class, 'updateSettings'])->middleware('admin.role:super_admin,admin_pmb')->name('pmb-cbt.settings.update');
    Route::post('/cbt/generate', [PmbCbtAdminController::class, 'generate'])->middleware('admin.role:super_admin,admin_pmb')->name('pmb-cbt.generate');
